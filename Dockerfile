...
LABEL org.label-schema.description="Telegram Integration Service Bot"
LABEL org.label-schema.name="mastrogiovanni/gobot"
LABEL org.label-schema.schema-version="1.0"
LABEL org.label-schema.vcs-url="https://github.com/mastrogiovanni/gobot"
LABEL org.label-schema.usage="https://github.com/mastrogiovanni/gobot/blob/main/README.md"
...
COPY --chown=nonroot:nonroot --from=build /go/bin/gobot /app/gobot
